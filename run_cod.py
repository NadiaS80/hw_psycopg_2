...
if __name__ == '__main__':
    ...
    creator = Create(database='homework_psycopg2', user='postgres', password='0819')
    creator.create_table_Client()
    creator.create_table_Phone()
    client_1 = DB_Control(database='homework_psycopg2', user='postgres', password='0819')
    client_2 = DB_Control(database='homework_psycopg2', user='postgres', password='0819')
    ...
    client_2.find_Client(last_name='van Rossum')